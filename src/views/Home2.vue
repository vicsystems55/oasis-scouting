  ...
  <div>
      ...
      <div class="hero-header d-non">
          ...
          <div id="hero-slider" class="hero-slider">
              ...
              <!-- Item Slide-->
              <div class="item-slider d-non" style="background:url(img/slide/2.jpg);">
                  <div class="container">
                      <div class="row align-items-center">
                          <div class="col-lg-7">
                              <div class="info-slider">
          ...
          <!-- End Hero Slider-->
            ...
            <div class="hero-header hero-bg d-none" style="background:url(img/slide/3.jpg);">
                <div class="container">
                    <div class="row">
      ...
      <!-- Section Area - Content Central -->
            <div class="hero-header">
                ...
                <div id="hero-slider" class="hero-slider">
                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center text-center">
                                <div class="col-lg-7">
                                    <div class="info-slider">
                                        <h1>The Next Greatest of All Times</h1>
                                        <p>Picking the best of the best.</p>
                                        <a href="#" class="btn-iw outline">Read More <i class="fa fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- Item Slide-->
                    <div class="item-slider d-non" style="background:url(img/slide/1.jpg);">
                        <div class="container">
                            <div class="row align-items-center justify-content-center text-center">
                                <div class="col-lg-7">
                                    <div class="info-slider">
              ...
              <div class="container">
                  ...
                  <div class="row portfolioContainer margin-top">
                      ...
                      <div class="col-sm-6 col-lg-4 col-xl-3 soccer">
                          <div class="item-gallery">
                              <div class="hover small">
                                  <img src="img/slide/3.jpg" alt="Club Team" />
                      ...
                      <div class="col-sm-6 col-lg-4 col-xl-3 soccer">
                          <div class="item-gallery">
                              <div class="hover small">
                                  <img src="img/blog/1.jpg" alt="Club Team" />
                      ...
                      <div class="col-sm-6 col-lg-4 col-xl-3 soccer">
                          <div class="item-gallery">
                              <div class="hover small">
                                  <img src="img/clubs-teams/argentina.jpg" alt="Club Team" />
                      ...
                      <div class="col-sm-6 col-lg-4 col-xl-3 soccer">
                          <div class="item-gallery">
                              <div class="hover small">
                                  <img src="img/clubs-teams/rusia.jpg" alt="Club Team" />
